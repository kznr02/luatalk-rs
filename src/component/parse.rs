...
use crate::concept::byte_code::ByteCode;
...
pub fn load(input: File) -> ParseProto {
    ...
    dbg!(&constants);
    dbg!(&byte_codes);
    ParseProto { constants: constants, byte_codes: byte_codes }
}
